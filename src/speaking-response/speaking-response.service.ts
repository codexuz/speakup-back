...
export class SpeakingResponseService {
   ...
   */
  async create(createDto: CreateSpeakingResponseDto): Promise<SpeakingResponse> {
  ...
  async findByUserAndTest(userId: string, testId: string): Promise<SpeakingResponse[]> {
    return this.speakingResponseModel.findAll({
      where: { 
        user_id: userId,
        test_id: testId 
  ...
  async update(id: string, updateDto: UpdateSpeakingResponseDto): Promise<SpeakingResponse> {
   ...
   */
  async batchAssessSpeakingResponses(userId: string, testId?: string): Promise<any[]> {
    try {
